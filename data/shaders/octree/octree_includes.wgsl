...
// Converts brick size from [0, BRICK_WORLD_SIZE] to [0, 1.0], then divides by atlas resolution
// to get position in atlas space
const SCULPT_TO_ATLAS_CONVERSION_FACTOR = (1.0 / BRICK_WORLD_SIZE) / SDF_RESOLUTION;
