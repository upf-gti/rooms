...
const SDF_BRICK_SIZE_WO_MARGIN = SDF_BRICK_SIZE - 2u;
const MATERIAL_BRICK_SIZE_WO_MARGIN = MATERIAL_BRICK_SIZE - 2u;
...
const PIXEL_MATERIAL_WORLD_SIZE = PIXEL_WORLD_SIZE / f32(SDF_MATERIAL_BRICK_DIFFERENCE);
const PIXEL_ATLAS_SIZE = PIXEL_WORLD_SIZE * SCULPT_TO_ATLAS_CONVERSION_FACTOR;
const BRICK_WORLD_SIZE = f32(SDF_BRICK_SIZE_WO_MARGIN) * PIXEL_WORLD_SIZE;
const BRICK_ATLAS_SIZE = f32(SDF_BRICK_SIZE_WO_MARGIN) / SDF_RESOLUTION;
const PIXEL_WORLD_SIZE_QUARTER = PIXEL_WORLD_SIZE / 4;

const SDF_TO_MATERIAL_CONVERSION_FACTOR = SDF_RESOLUTION / SDF_BRICK_SIZE;
