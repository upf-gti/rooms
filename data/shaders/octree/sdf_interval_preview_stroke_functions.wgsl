...
fn eval_interval_preview_stroke_sphere_smooth_union(position : mat3x3f, current_surface : vec2f, dimension_margin : vec4f) -> vec2f
{
...
fn eval_interval_preview_stroke_sphere_smooth_substract(position : mat3x3f, current_surface : vec2f, dimension_margin : vec4f) -> vec2f
{
    var result_surface : vec2f = current_surface;
    var tmp_surface : vec2f;
...
fn eval_interval_preview_stroke_box_smooth_union(position : mat3x3f, current_surface : vec2f, dimension_margin : vec4f) -> vec2f
{
    var result_surface : vec2f = current_surface;
    var tmp_surface : vec2f;
...
fn eval_interval_preview_stroke_capsule_smooth_union(position : mat3x3f, current_surface : vec2f, dimension_margin : vec4f) -> vec2f
{
    var result_surface : vec2f = current_surface;
    var tmp_surface : vec2f;
...
fn eval_interval_preview_stroke_cone_smooth_union(position : mat3x3f, current_surface : vec2f, dimension_margin : vec4f) -> vec2f
{
    var result_surface : vec2f = current_surface;
    var tmp_surface : vec2f;
...
fn eval_interval_preview_stroke_cylinder_smooth_union(position : mat3x3f, current_surface : vec2f, dimension_margin : vec4f) -> vec2f
{
    var result_surface : vec2f = current_surface;
    var tmp_surface : vec2f;
...
fn eval_interval_preview_stroke_torus_smooth_union(position : mat3x3f, current_surface : vec2f, dimension_margin : vec4f) -> vec2f
{
    var result_surface : vec2f = current_surface;
    var tmp_surface : vec2f;
...
fn eval_interval_preview_stroke_vesica_smooth_union(position : mat3x3f, current_surface : vec2f, dimension_margin : vec4f) -> vec2f
{
    var result_surface : vec2f = current_surface;
    var tmp_surface : vec2f;
...
fn evaluate_preview_stroke_interval( position: mat3x3f, current_surface : vec2f, center : vec3f, half_size : f32) -> vec2f
{
    ...
    switch(curr_stroke_code) {
        case SD_SPHERE_SMOOTH_OP_UNION: {
            result_surface = eval_interval_preview_stroke_sphere_smooth_union(position, current_surface, vec4f(0.0));
            break;
        }
        case SD_SPHERE_SMOOTH_OP_SUBSTRACTION: {
            result_surface = eval_interval_preview_stroke_sphere_smooth_substract(position, current_surface, vec4f(0.0));
            break;
        }
        case SD_BOX_SMOOTH_OP_UNION: {
            result_surface = eval_interval_preview_stroke_box_smooth_union(position, current_surface, vec4f(0.0));
            break;
        }
        case SD_BOX_SMOOTH_OP_SUBSTRACTION: {
            result_surface = eval_interval_preview_stroke_box_smooth_union(position, initial_surface, vec4f(0.0));
            result_surface = opSmoothSubtractionInterval(current_surface, result_surface, smooth_factor);
            break;
        }
        case SD_CAPSULE_SMOOTH_OP_UNION: {
            result_surface = eval_interval_preview_stroke_capsule_smooth_union(position, current_surface, vec4f(0.0));
            break;
        }
        case SD_CAPSULE_SMOOTH_OP_SUBSTRACTION: {
            result_surface = eval_interval_preview_stroke_capsule_smooth_union(position, initial_surface, vec4f(0.0));
            result_surface = opSmoothSubtractionInterval(current_surface, result_surface, smooth_factor);
            break;
        }
        case SD_CONE_SMOOTH_OP_UNION: {
            result_surface = eval_interval_preview_stroke_cone_smooth_union(position, current_surface, vec4f(0.0));
            break;
        }
        case SD_CONE_SMOOTH_OP_SUBSTRACTION: {
            result_surface = eval_interval_preview_stroke_cone_smooth_union(position, initial_surface, vec4f(0.0));
            result_surface = opSmoothSubtractionInterval(current_surface, result_surface, smooth_factor);
            break;
        }
        case SD_CYLINDER_SMOOTH_OP_UNION: {
            result_surface = eval_interval_preview_stroke_cylinder_smooth_union(position, current_surface, vec4f(0.0));
            break;
        }
        case SD_CYLINDER_SMOOTH_OP_SUBSTRACTION: {
            result_surface = eval_interval_preview_stroke_cylinder_smooth_union(position, initial_surface, vec4f(0.0));
            result_surface = opSmoothSubtractionInterval(current_surface, result_surface, smooth_factor);
            break;
        }
        case SD_TORUS_SMOOTH_OP_UNION: {
            result_surface = eval_interval_preview_stroke_torus_smooth_union(position, current_surface, vec4f(0.0));
            break;
        }
        case SD_TORUS_SMOOTH_OP_SUBSTRACTION: {
            result_surface = eval_interval_preview_stroke_torus_smooth_union(position, initial_surface, vec4f(0.0));
            result_surface = opSmoothSubtractionInterval(current_surface, result_surface, smooth_factor);
            break;
        }
        case SD_VESICA_SMOOTH_OP_UNION: {
            result_surface = eval_interval_preview_stroke_vesica_smooth_union(position, current_surface, vec4f(0.0));
            break;
        }
        case SD_VESICA_SMOOTH_OP_SUBSTRACTION: {
            result_surface = eval_interval_preview_stroke_vesica_smooth_union(position, initial_surface, vec4f(0.0));
            result_surface = opSmoothSubtractionInterval(current_surface, result_surface, smooth_factor);
            break;
        }
        default: {}
