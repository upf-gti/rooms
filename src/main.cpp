...
int main()
{
    ...
    required_limits.limits.maxBufferSize = MATERIAL_BRICK_SIZE * MATERIAL_BRICK_SIZE * MATERIAL_BRICK_SIZE * sizeof(float) * 4;
    required_limits.limits.maxStorageBufferBindingSize = MATERIAL_BRICK_SIZE * MATERIAL_BRICK_SIZE * MATERIAL_BRICK_SIZE * sizeof(float) * 4;
