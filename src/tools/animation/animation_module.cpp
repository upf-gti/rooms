...
void AnimationModule::initialize()
{
    ...
    cube_material.color = colors::PURPLE;
    cube_material.flags |= MATERIAL_PBR;
    cube_material.shader = RendererStorage::get_shader("data/shaders/mesh_pbr.wgsl", cube_material);
...
void AnimationModule::clean()
{

}

void AnimationModule::update(float delta_time)
{
...
void AnimationModule::render_gui()
{
    if (animation)
    {
