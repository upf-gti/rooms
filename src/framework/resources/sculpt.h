...
public:
    Sculpt(const uint32_t id, const Uniform uniform, const Uniform indiret_buffer, const Uniform indices_buffer, const WGPUBindGroup octree_bind, const WGPUBindGroup eval_sculpt_bindgroup, const WGPUBindGroup readonly_bindgroup):
