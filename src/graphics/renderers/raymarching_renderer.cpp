...
void RaymarchingRenderer::compute_octree()
{
    ...
    webgpu_context->update_buffer(std::get<WGPUBuffer>(octree_edit_culling_data.data), octree_total_size * MAX_EDITS_PER_EVALUATION, &current_stroke->edit_count, sizeof(uint32_t));
